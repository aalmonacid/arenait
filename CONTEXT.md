...
4. **Links de navegación rotos**: "Servicios", "Casos de Estudio" y "FinOps" en el header apuntan a `#`. **Sigue pendiente.**
5. **Sin CSP en `vercel.json`** — hay HSTS, X-Frame-Options, X-Content-Type-Options, Referrer-Policy y Permissions-Policy, pero falta `Content-Security-Policy`, inconsistente con el posicionamiento "ISO 27001 / seguridad estructural" del propio sitio. **Sigue pendiente.**
